...
<div class="container">
	...
	<main class="row">
		<section class="col-xs-9">
			<h2 class="name"><struts:property value='director.name' /></h2>
            <div class="introduce">
            	<struts:property value='director.description' />
            </div><br>
            <div class="row">
		...
		<aside class="col-xs-3">
       		<div><img src="images/director/<struts:property value='director.id' />.jpg" /></div>
		</aside>
	</main>
	<footer class="row">
