		...
		<section class="row">
			...
			<div class="col-sm-8 col-xs-12">
				...
				<p class="moviename detail">
					导演：
					<a href="movieAction_director?director.id=<struts:property value='movie.director.id' />">
						<struts:property value='movie.director.name' />
					</a>
					&#12288;&#12288;主角：
					<a href="movieAction_actor?actor.id=<struts:property value='movie.actor.id' />">		
						<struts:property value='movie.actor.name' />
					</a>
				</p>
					...
					<struts:iterator value="movie.comments">
						<div class="result" style="margin-top:10px">
							...
							<struts:if test="#session.user.admin==true">
								<div>
									<a
										href="adminAction_deleteComment?comment.id=<struts:property value='id' />">[删除]</a>
								</div>
							</struts:if>
						</div>
					</struts:iterator>
