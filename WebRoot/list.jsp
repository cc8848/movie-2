	...
	<div class="container">
		...
		<nav class="row">
			<ul class="nav nav-pills text-center">
				<li class="col-xs-12 col-md-2"><a href="indexAction">首页</a></li>
				<struts:iterator value="kinds">
					<li class="col-xs-12 col-md-2<struts:if test='id==kind.id'> active</struts:if>"><a href="movieAction_list?kind.id=<struts:property value='id'/>"><struts:property value="name"/></a></li>
				</struts:iterator>
			</ul>
		</nav>
		<div class="row">
